...
+ (NSURL *)getGravatarUrl:(NSString *)email size:(NSInteger)size {
    ...
    int squareSideLength = size;
    
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://www.gravatar.com/avatar/%@.jpg?d=retro&s=%d", hexValue, squareSideLength]];
